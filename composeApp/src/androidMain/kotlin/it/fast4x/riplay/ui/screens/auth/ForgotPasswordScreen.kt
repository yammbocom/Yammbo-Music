...
fun ForgotPasswordScreen(
    ...
    val enterEmailText = stringResource(R.string.auth_enter_email)
    val resetLinkSentFallback = stringResource(R.string.auth_reset_description)
    val failedText = stringResource(R.string.auth_login_failed)
    ...
    Column(
        ...
        BasicText(
            ...
            style = typo.xxs.copy(color = colors.textSecondary, textAlign = TextAlign.Center),
        ...
        Button(
            onClick = {
                ...
                coroutineScope.launch {
                    YammboApiService.forgotPassword(email.trim())
                        .onSuccess { response ->
                            if (response.isSuccess) {
                                ...
                                errorMessage = response.firstError ?: "Failed to send reset link"
                                successMessage = null
                            }
                        }
                        .onFailure { e ->
